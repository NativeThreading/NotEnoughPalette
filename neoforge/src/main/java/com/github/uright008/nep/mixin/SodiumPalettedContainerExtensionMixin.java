 ...
 * can bulk-unpack a whole section through NEP's direct-array
 * {@code fillArray} instead of the inherited {@code sodium$unpack}
 * which reads the stale {@code PalettedContainer.data} field.
 *
 ...
 * {@code PalettedContainerROExtension} from Sodium's own mixin.</p>
 *
